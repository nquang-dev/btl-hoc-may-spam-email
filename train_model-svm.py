...
os.makedirs('/home/nquang/C_CODE/1_HOC-MAY/spam_email_ver-3/checkpoints', exist_ok=True)

# Bước 1: Đọc tệp dữ liệu
print("Đang đọc dữ liệu...")
data = pd.read_csv('/home/nquang/C_CODE/1_HOC-MAY/spam_email_ver-3/spam_ham_dataset.csv')
...
plt.ylabel('Actual')
plt.savefig('/home/nquang/C_CODE/1_HOC-MAY/spam_email_ver-3/checkpoints/confusion_matrix.png')
print("Heatmap đã được lưu tại: /home/nquang/C_CODE/1_HOC-MAY/spam_email_ver-3/checkpoints/confusion_matrix.png")

# Bước 6: Lưu mô hình và vectorizer
model_path = '/home/nquang/C_CODE/1_HOC-MAY/spam_email_ver-3/checkpoints/spam_detection_model.pkl'
vectorizer_path = '/home/nquang/C_CODE/1_HOC-MAY/spam_email_ver-3/checkpoints/tfidf_vectorizer.pkl'
